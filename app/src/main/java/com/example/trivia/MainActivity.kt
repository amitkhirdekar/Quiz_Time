...
class MainActivity : AppCompatActivity() {
    ...
    override fun onRestart() {
        super.onRestart()
        Log.i("MainActivity","onRestart for Activity called")
        Toast.makeText(this,"Minimizing App in between is not Expected! Ignore if sharing Success",Toast.LENGTH_SHORT).show()
    }
