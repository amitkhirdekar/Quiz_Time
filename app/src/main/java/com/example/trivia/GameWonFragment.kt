...
class GameWonFragment : Fragment() {
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        binding.buttonShare.setOnClickListener{shareSuccess()}

        Toast.makeText(context,"Congratulations on Completing the Game", Toast.LENGTH_LONG).show()
        return binding.root
    }
    ...
    private fun getShareIntent() : Intent {
        ...
        val emailRecipient = getString((R.string.developer_email))
